export class AppSettings{
    public static EMAIL_NL = `\n\n`;// Email new line
    public static  EMAIL_SOL = `  `; //Email start of line
    public static MAC_FOLDER_SEPARATOR = `/`;
    public static ALL_CATEGORIES = "All Categories or Campaigns";
    public static CREATE_PERTINENT_QUESTIONS = 'Create Pertinent Questions';
    public static CREATE_PERTINENT_ACTIONS = 'Create Pertinent Actions';
    ...
    public static MENTIONED_SPECIFIER = `mentioned:`;
...
//    public static VIDEO_EMBED2 = `" frameborder="0" autoplay="0" autostart="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>`
    public static VIDEO_EMBED1 = `<video width="600" height="400" src="`;
    public static VIDEO_EMBED2 = `" controls></video>`;
    public static TAGS_SPECIFIER = `tags:`;
